...
2.  What's the `tidyverse` Package? Describe in maximum two sentences below.
    ...
    **Answer:**
    ...
    tidyverse package is a collection of R packages focusing on data manipulation, visualization, and modeling. It includes packages like dplyr, ggplot2.
...
![](figs/fig-01-mean-waste-composition-by-income.png){width="2400"}
